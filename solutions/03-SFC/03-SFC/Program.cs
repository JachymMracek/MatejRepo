    ...
    Parser.Default.ParseArguments<Options>(args)
      .WithParsed<Options>(o =>
      {
        ...
        switch (o.Method)
        {
          ...
          case 1:
            sfc = new SimpleDiagonal(pixelAction);
            break;
          case 2:
            sfc = new DFSCurve(pixelAction);
            break;
          case 3:
            sfc = new Spirala(pixelAction);
            break;
          case 4:
            sfc = new BFS(pixelAction);
            break;
          case 5:
        ...
        if (o.Method == 1)
        {
          Console.WriteLine($"Order: SimpleDiagonal");
        }
        if (o.Method == 2)
        {
          Console.WriteLine($"Order: DFSCurve");
        }
        if (o.Method == 3)
        {
